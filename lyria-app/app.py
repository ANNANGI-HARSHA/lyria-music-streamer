...
def generate_clip():
    """Generate a music clip and return the URL."""
    if not API_KEY:
    ...
    try:
        ...
        audio_chunks = asyncio.run(generate_audio_async(prompt, duration))
...
async def generate_audio_async(prompt: str, duration: int):
    """Async function to generate audio from Lyria."""
    import time
